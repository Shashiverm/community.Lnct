...
import { ArrowLeft, Calendar, Clock, Plus, X, MapPin, CalendarPlus, AlertTriangle } from "lucide-react"
...
export default function CreateEventPage() {
  ...
  }, [isAuthenticated, isFaculty, router, toast])
  ...
  // If not faculty, show access denied message
  if (isAuthenticated && !isFaculty) {
    return (
      <div className="container py-8">
        <Card className="max-w-md mx-auto">
          <CardHeader>
            ...
            <CardDescription className="text-center">Only faculty members can create events</CardDescription>
          </CardHeader>
